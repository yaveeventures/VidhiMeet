...
function renderBankAccount() {
  ...
  if (!bankAccount) {
    display.innerHTML = `
      <p class="muted" style="padding:4px 0 12px;font-size:13px;line-height:1.5;">
        Link your bank account to enable direct weekly consultation payouts.
      </p>
      <div style="display:flex;flex-direction:column;gap:10px;">
        <button class="primary" id="auto-link-rpd-btn" style="width:100%;display:flex;align-items:center;justify-content:center;gap:8px;padding:12px;background:var(--forest);color:#fff;border-radius:10px;font-weight:700;font-size:14px;">
          ⚡ Auto-Link &amp; Verify via UPI (Reverse Penny Drop)
        </button>
        <button class="secondary" id="add-bank-btn" style="width:100%;padding:10px;border-radius:10px;font-size:13px;background:#f3f4f6;color:var(--dark);border:1px solid var(--line);">
