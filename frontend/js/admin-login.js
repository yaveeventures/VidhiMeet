...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (urlParams.get("reason") === "inactivity" || reason === "inactivity") {
    ...
    const errorEl = document.getElementById("admin-login-error");
    if (errorEl) {
      errorEl.textContent = "Your administrative session expired due to 15 minutes of inactivity (DPDP Act compliance). Please sign in again.";
      errorEl.style.display = "block";
      errorEl.style.background = "rgba(245, 158, 11, 0.15)";
