# Graph Report - VidhiMeet  (2026-09-09)

## Corpus Check
- 103 files · ~170,137 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1825 nodes · 4868 edges · 84 communities (68 shown, 16 thin omitted)
...
Cohesion: 0.06
Nodes (43): FrontendStaticFiles, lifespan(), EncryptedString, authenticate_stream_user(), Request, Session, Server-Sent Events (SSE) stream endpoint for real-time notifications and UI auto, sse_event_stream() (+35 more)
...
Cohesion: 0.12
Nodes (11): ar(), br, fn(), ft(), hn(), ir(), mr, pr() (+3 more)
...
### Community 7 - "i"
Cohesion: 0.06
Nodes (66): LawyerProfile, User, admin_metrics(), get_admin_payouts(), get_audit_logs(), get_ntp_status(), get_platform_feedback(), list_disputes() (+58 more)
...
Cohesion: 0.09
Nodes (36): get_settings(), rate_limit_dependency(), drafting_document_mock_upload(), drafting_document_presign(), UploadFile, Helper to write a mock PDF file when serving local document downloads., _write_mock_pdf(), download_lawyer_document() (+28 more)

### Community 15 - "calendar.py"
Cohesion: 0.18
Nodes (5): Ae(), ee(), gt(), qt, re()
...
Cohesion: 0.12
Nodes (27): a(), B(), Bt(), c(), cr(), d(), er(), f() (+19 more)
...
Cohesion: 0.06
Nodes (23): Booking, booking_ics(), _build_ics_calendar(), _build_vevent(), _escape(), _fmt_dt(), _fold(), get_ical_token() (+15 more)
...
### Community 35 - "test_rate_limiter.py"
Cohesion: 0.17
...
Cohesion: 0.09
Nodes (36): Base, get_db(), AuditLog, now(), PasswordResetToken, datetime, RefreshToken, UserConsent (+28 more)

### Community 68 - "sanitize_key"
Cohesion: 0.06
Nodes (53): as(), Bo(), ce(), de(), Ds(), dt(), ea(), Fo() (+45 more)
...
- **Why does `User` connect `i` to `test_password_reset.py`, `lawyer.js`, `main.py`, `processEvent`, `sanitize_key`, `LawyerGrid`, `8dcb01bed07f_initial_schema.py`, `PlatformFeedback`, `_e`, `80394484e25e_add_phonepe_transaction_id.py`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `_launchDaily()` connect `je` to `mr`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `Booking` connect `PlatformFeedback` to `test_password_reset.py`, `lawyer.js`, `i`, `processEvent`, `LawyerGrid`, `8dcb01bed07f_initial_schema.py`, `T`?**
