...
## Corpus Check
- 108 files · ~177,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1905 nodes · 5074 edges · 85 communities (68 shown, 17 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 588 edges (avg confidence: 0.57)
...
### Community 0 - "main.py"
Cohesion: 0.06
Nodes (90): BookingStatus, DraftingStatus, LawyerBankAccount, Practice, ProposalStatus, str, One-per-lawyer bank account for payout and UPI identity verification., Role (+82 more)
...
Cohesion: 0.09
Nodes (25): EncryptedString, _save_ws_message(), _validate_ws_user_and_booking(), decrypt_field(), encrypt_field(), _get_fernet_cipher(), Enforce strict participant boundary isolation (BOLA/IDOR defense)., validate_participant_access() (+17 more)
...
Cohesion: 0.13
Nodes (20): check_clock_drift(), _get_servers(), ntp_now(), ntp_now_ist(), NtpStatus, datetime, _query_ntp_server(), ntp_time.py ----------- NTP time synchronization for CERT-In and DPDP forensic t (+12 more)

### Community 14 - "LawyerGrid"
Cohesion: 0.06
Nodes (47): get_settings(), FrontendStaticFiles, lifespan(), rate_limit_dependency(), drafting_document_mock_upload(), UploadFile, download_lawyer_document(), get_my_profile() (+39 more)
...
Cohesion: 0.15
Nodes (33): User, Voucher, booking_for_participant(), cancel_booking(), cancellation_preview(), complete_booking(), confirm_document(), confirm_payment() (+25 more)
...
Cohesion: 0.09
Nodes (39): Base, AuditLog, Message, now(), PasswordResetToken, datetime, RefreshToken, Review (+31 more)
...
### Community 40 - "test_cancellation.py"
Cohesion: 0.64
...
Cohesion: 0.09
Nodes (22): Booking, cashfree_webhook(), Request, Session, Handle Cashfree PG Webhook events (e.g. PAYMENT_SUCCESS_WEBHOOK, ORDER_PAID)., evaluate_daily_meeting_logs(), Session, Queries Daily.co REST API or room session logs for the booking's room,     calcu (+14 more)
...
Cohesion: 0.08
Nodes (35): get_db(), LawyerProfile, PlatformFeedback, admin_metrics(), get_admin_payouts(), get_audit_logs(), get_platform_feedback(), list_disputes() (+27 more)
...
- **Why does `User` connect `8dcb01bed07f_initial_schema.py` to `main.py`, `test_password_reset.py`, `services.py`, `lawyer.js`, `test_cancellation.py`, `LawyerProfile`, `main.py`, `LawyerGrid`, `check_clock_drift`, `PlatformFeedback`, `bank_accounts.py`, `80394484e25e_add_phonepe_transaction_id.py`, `Booking`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Booking` connect `Booking` to `test_password_reset.py`, `services.py`, `lawyer.js`, `LawyerProfile`, `LawyerGrid`, `check_clock_drift`, `8dcb01bed07f_initial_schema.py`, `PlatformFeedback`, `T`?**
