...
## Corpus Check
- 65 files · ~63,930 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 955 nodes · 2783 edges · 49 communities (38 shown, 11 thin omitted)
...
- test_disabled_rate_limiter_setting
...
### Community 0 - "main.py"
Cohesion: 0.23
Nodes (11): AsyncSession, AuditLog, UserConsent, login(), Session, register(), request_erasure(), issue_refresh_token() (+3 more)

### Community 1 - "mr"
Cohesion: 0.08
Nodes (61): $(), checkInactivity(), LexAPI, openChatModal(), LexE2EE, aadhaarFileEl, barLicenceFileEl, bookings (+53 more)
...
### Community 6 - "main.py"
Cohesion: 0.27
Nodes (16): Review, booking_for_participant(), complete_booking(), confirm_document(), confirm_payment(), create_review(), dispute_booking(), document_upload() (+8 more)
...
Cohesion: 0.08
Nodes (60): Base, BookingStatus, DraftingStatus, EncryptedString, Practice, ProposalStatus, RefreshToken, Role (+52 more)

### Community 25 - "processEvent"
Cohesion: 0.13
Nodes (8): get_settings(), Configure structured JSON logging for production or key-value console logging fo, setup_logging(), lifespan(), Request, security_headers_and_rate_limit(), FastAPI, reset_rate_limiter()
...
### Community 27 - "money"
Cohesion: 0.05
Nodes (56): LawyerBankAccount, One-per-lawyer bank account for payout and UPI identity verification., add_bank_account(), _bank_account_out(), delete_bank_account(), get_bank_account(), initiate_upi_verification(), _mask_account() (+48 more)

### Community 31 - "pdf-annotator.js"
Cohesion: 0.11
Nodes (13): get_db(), Booking, now(), datetime, phonepe_webhook(), Request, Session, stripe_webhook() (+5 more)

### Community 32 - "data_retention_purge.py"
Cohesion: 0.20
Nodes (17): Message, _cutoff(), _ensure_tz(), log_purge_audit(), _now(), purge_expired_bookings(), purge_expired_tokens(), purge_withdrawn_consents() (+9 more)
...
- **Why does `User` connect `qt` to `main.py`, `main.py`, `o`, `Base`, `audit`, `.must_be_adult`, `public.py`, `er`, `models.py`, `processEvent`, `money`, `pdf-annotator.js`?**
