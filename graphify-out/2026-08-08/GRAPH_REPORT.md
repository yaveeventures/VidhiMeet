# Graph Report - LawyerGrid  (2026-08-08)

## Corpus Check
- 72 files · ~78,190 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1092 nodes · 2850 edges · 70 communities (46 shown, 24 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 520 edges (avg confidence: 0.62)
...
5. `LexAPI` - 45 edges
6. `Role` - 42 edges
7. `BookingStatus` - 42 edges
8. `je()` - 39 edges
9. `LawyerProfile` - 38 edges
10. `DraftingStatus` - 38 edges
...
### Community 0 - "main.py"
Cohesion: 0.11
Nodes (11): Ae(), B(), br, ee(), qn(), qt, re(), ue() (+3 more)

### Community 1 - "mr"
Cohesion: 0.07
Nodes (65): $(), openChatModal(), LexE2EE, aadhaarFileEl, ALL_TIME_SLOTS, barLicenceFileEl, bindTimeSelectListeners(), bookings (+57 more)

### Community 2 - "je"
Cohesion: 0.05
Nodes (40): as(), be(), Bt(), cr(), dr(), dt(), er(), g() (+32 more)

### Community 3 - "lawyer.js"
Cohesion: 0.09
Nodes (31): _attemptReconnect(), backdrop, booking, checkHashRoute(), _clearReconnectOverlay(), close(), closeModal(), content (+23 more)

### Community 4 - "app.js"
Cohesion: 0.12
Nodes (11): ar(), fn(), ir(), Kn(), kr(), mr, pr(), preprocessEvent() (+3 more)

### Community 5 - "daily-js.js"
Cohesion: 0.11
Nodes (42): $(), auditLogs, checkAdminSession(), colors, decideVerification(), disputes, draftingTransactions, escapeHtml() (+34 more)
...
Cohesion: 0.11
Nodes (31): Bo(), Ds(), ea(), Fo(), Fs(), Go(), h(), Ho() (+23 more)

### Community 9 - "User"
Cohesion: 0.27
Nodes (20): Message, Review, User, booking_for_participant(), cancel_booking(), cancellation_preview(), complete_booking(), confirm_document() (+12 more)

### Community 10 - "audit"
Cohesion: 0.15
Nodes (21): AsyncSession, DraftComment, DraftingProposal, DraftingRequest, accept_drafting_proposal(), accept_drafting_request(), add_draft_comment(), approve_draft() (+13 more)

### Community 11 - "Session"
Cohesion: 0.11
Nodes (53): BookingStatus, DraftingStatus, Practice, ProposalStatus, str, Role, AdminPayoutAccountOut, AuditLogOut (+45 more)
...
Cohesion: 0.07
Nodes (35): PlatformFeedback, booking_ics(), _build_ics_calendar(), _build_vevent(), _escape(), _fmt_dt(), _fold(), get_ical_token() (+27 more)
...
Cohesion: 0.07
Nodes (28): get_db(), Booking, LawyerProfile, PhonePe webhook with VERIFY- prefix updates LawyerBankAccount, not a Booking., test_phonepe_verify_webhook_routes_correctly(), test_get_booking_by_id(), test_phonepe_webhook_verification(), admin_metrics() (+20 more)
...
Cohesion: 0.10
Nodes (11): Base, EncryptedString, now(), datetime, WebhookEvent, phonepe_webhook(), stripe_webhook(), Reset script: delete ALL users (lawyers, clients, admin) and related data, then (+3 more)
...
Cohesion: 0.20
Nodes (18): bookingView(), getColorForName(), getIntakeKeys(), getIntakeQuestions(), getSpecialty(), getYearsExperience(), handlePay(), initBookingLanding() (+10 more)
...
### Community 34 - "LexAPI"
Cohesion: 0.26
Nodes (15): checkInactivity(), LexAPI, downloadBookingIcs(), escapeHtml(), loadDraftingRequests(), openAuthModal(), openCancelModal(), openDisputeModal() (+7 more)

### Community 35 - "test_bank_account.py"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (32): AuditLog, RefreshToken, UserConsent, rate_limit_dependency(), google_auth(), login(), Session, refresh() (+24 more)
...
- **Why does `je()` connect `i` to `main.py`, `je`, `_e`, `__init__.py`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `s()` connect `gn` to `mr`, `je`, `daily-js.js`, `processEvent`, `register`, `__init__.py`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `LexAPI` connect `LexAPI` to `mr`, `lawyer.js`, `daily-js.js`, `processEvent`, `models.py`, `T`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Are the 29 inferred relationships involving `User` (e.g. with `Base` and `login()`) actually correct?**
  _`User` has 29 INFERRED edges - model-reasoned connections that need verification._
- **Are the 27 inferred relationships involving `audit()` (e.g. with `add_bank_account()` and `delete_bank_account()`) actually correct?**
  _`audit()` has 27 INFERRED edges - model-reasoned connections that need verification._
- **Are the 37 inferred relationships involving `Practice` (e.g. with `Base` and `AdminPayoutAccountOut`) actually correct?**
  _`Practice` has 37 INFERRED edges - model-reasoned connections that need verification._
- **Are the 12 inferred relationships involving `Booking` (e.g. with `Base` and `request_erasure()`) actually correct?**
