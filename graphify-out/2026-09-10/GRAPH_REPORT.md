...
## Corpus Check
- 103 files · ~170,079 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1826 nodes · 4869 edges · 80 communities (65 shown, 15 thin omitted)
...
### Community 0 - "main.py"
Cohesion: 0.07
Nodes (83): Base, FrontendStaticFiles, BookingStatus, DraftComment, DraftingProposal, DraftingRequest, DraftingStatus, Practice (+75 more)
...
Cohesion: 0.06
Nodes (45): EncryptedString, Message, now(), PasswordResetToken, datetime, RefreshToken, WebhookEvent, Reset password using a valid, single-use, 15-minute reset token.     Hashes new (+37 more)
...
Cohesion: 0.11
Nodes (12): ar(), br, fn(), hn(), ir(), mr, pr(), q() (+4 more)
...
Cohesion: 0.10
Nodes (24): Bt(), ce(), de(), dt(), ee(), ft(), ht(), J() (+16 more)

### Community 10 - "N"
Cohesion: 0.24
Nodes (11): be(), ge(), ie(), le(), me(), ne(), oe(), te() (+3 more)

### Community 11 - "LawyerProfile"
Cohesion: 0.14
Nodes (10): get_db(), AuditLog, LawyerProfile, UserConsent, request_erasure(), test_lawyer_complete_booking_duration_restriction(), test_meeting_token_endpoint(), test_verified_reviews_only() (+2 more)
...
Cohesion: 0.06
Nodes (37): Sanitize sensitive PII keys and credentials before log rendering., Configure structured JSON logging for production or key-value console logging fo, scrub_sensitive_pii_processor(), setup_logging(), _cors_response(), http_exception_handler(), integrity_exception_handler(), lifespan() (+29 more)

### Community 14 - "LawyerGrid"
Cohesion: 0.06
Nodes (40): get_settings(), Settings, rate_limit_dependency(), download_drafting_document(), drafting_document_mock_upload(), drafting_document_presign(), UploadFile, Helper to write a mock PDF file when serving local document downloads. (+32 more)
...
Cohesion: 0.09
Nodes (37): Booking, Review, Voucher, booking_for_participant(), cancel_booking(), cancellation_preview(), complete_booking(), confirm_document() (+29 more)

### Community 18 - "9d0be6640444_add_aadhaar_and_profile_picture.py"
Cohesion: 0.11
Nodes (29): a(), B(), bn(), c(), cr(), d(), er(), f() (+21 more)

### Community 19 - "toast"
Cohesion: 0.16
Nodes (18): check_clock_drift(), _get_servers(), ntp_now(), ntp_now_ist(), NtpStatus, datetime, _query_ntp_server(), ntp_time.py ----------- NTP time synchronization for CERT-In and DPDP forensic t (+10 more)
...
Cohesion: 0.16
Nodes (22): Ae(), ct(), dn(), Et(), fe(), i(), In(), It() (+14 more)
...
### Community 28 - "T"
Cohesion: 0.13
Nodes (21): _cutoff(), _ensure_tz(), log_purge_audit(), _now(), purge_expired_bookings(), purge_expired_tokens(), purge_withdrawn_consents(), data_retention_purge.py ----------------------- DPDP Act 2023, Section 8(7) — Da (+13 more)
...
Cohesion: 0.10
Nodes (44): AsyncSession, User, admin_metrics(), get_admin_payouts(), get_audit_logs(), get_ntp_status(), get_platform_feedback(), list_disputes() (+36 more)

### Community 68 - "sanitize_key"
Cohesion: 0.07
Nodes (41): as(), at(), Bo(), Bs(), Ds(), ea(), Es(), Fo() (+33 more)
...
- **Why does `User` connect `test_password_reset.py` to `main.py`, `9b17288bd3cf_add_cancellation_fields_and_vouchers.py`, `lawyer.js`, `i`, `LawyerProfile`, `sanitize_key`, `LawyerGrid`, `check_clock_drift`, `8dcb01bed07f_initial_schema.py`, `toast`, `PlatformFeedback`, `_e`, `80394484e25e_add_phonepe_transaction_id.py`, `_cors_response`?**
